...
<div class="container">
    ...
    <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
        ...
        alt="Capa do Livro" class="img-fluid"
        style="max-height: 300px; max-width: 200px; object-fit: cover;">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('pages') is-invalid @enderror" id="pages" name="pages" value="{{ old('title', $book->pages) }}" required>
            @error('pages')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
